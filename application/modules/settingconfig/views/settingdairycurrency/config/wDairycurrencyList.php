...
<div class="row">
    ...
    <div class="col-xs-4 col-md-8 col-lg-8 text-right" style="margin-top:25px;">
            <div id="odvBtnAddEdit" style="display: block;">
                    <button onclick="JSxSETSavesss()" type="button" class="btn xCNBTNPrimery xCNBTNPrimery2Btn" style="margin-left: 5px;" style="display: block;"><?=language('common/main/main', 'tSave'); ?></button>
                </div>
            </div>
        </div>
    </div>
