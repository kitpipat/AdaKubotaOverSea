<div class="table-responsive">
    <table class="table table-striped xWPdtTableFont" id="otbPromotionStep4ZoneConditionTable">
        <thead>
            <tr>
        ...
        <tbody>
            <?php if ($aDataList['rtCode'] == 1) { ?>
                <?php foreach ($aDataList['raItems'] as $key => $aValue) { ?>
                    <tr 
                    class="xCNTextDetail2 xCNPromotionPdtPmtHDZoneRow" 
                    data-bch-code="<?php echo $aValue['FTBchCode']; ?>" 
                    data-doc-no="<?php echo $aValue['FTPmhDocNo']; ?>" 
                    data-chn-code="<?php echo $aValue['FTZneCode']; ?>"
                    data-znechi-code="<?php echo $aValue['FTZneChain']; ?>">

                        <td class="text-center"><?php echo $key+1; ?></td>
                        <td class="text-left">
                            <select class="xCNApvOrCanCelDisabledPdtPmtHDZone form-control xCNPromotionStep3PgtStaGetType" onchange="JSxPromotionStep4ZoneConditionDataTableEditInline(this)">
                        ...
                        <td class="text-left"><?php echo $aValue['FTZneChain']; ?></td>
...
<?php include('script/jStep4ZoneConditionTableTmp.php'); ?>