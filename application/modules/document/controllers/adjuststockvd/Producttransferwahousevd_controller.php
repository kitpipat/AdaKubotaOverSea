...
class Producttransferwahousevd_controller extends MX_Controller {
	...
	public function __construct() {
            ...
            $this->load->model('document/adjuststockvd/Producttransferwahousevd_model');
    ...
    public function FSvCTFWGetShipAdd(){
        ...
        $aDataShipAdd = $this->Producttransferwahousevd_model->FSaMTFWGetAddress($tBchCode,$tXthShipAdd,$nLangEdit); 
    ...
    public function FSaCTFWEditEvent(){
        try{
            ...
            $this->db->trans_begin();
            $aStaSdtOrdHD               = $this->Producttransferwahousevd_model->FSaMTFWAddUpdateHD($aDataMaster);
            $aStaEventDocNoInDocTemp    = $this->Producttransferwahousevd_model->FSaMTFWAddUpdateDocNoInDocTemp($aDataWhere);    //Update DocNo ในตาราง Doctemp
            $aResInsDT      =  $this->Producttransferwahousevd_model->FSaMTFWInsertTmpToDT($aDataWhere);
    ...
    public function FSaMTFWSumDTIntoHD($ptXthDocNo){
        ...
        $aDataDT    =   $this->Producttransferwahousevd_model->FSaMTFWGetDT($aData); //*ลบ Data เก่าออก*/
        ...
        $aDataDT    =   $this->Producttransferwahousevd_model->FSaMTFWUpdateHDFCXthTotal($aDataUpdHD,$tXthDocNo); //*ลบ Data เก่าออก*/
    ...
    public function FSvCTFWEditPdtIntoTableDT(){
        ...
        //Edit Inline
        $aResUpdDTTmpInline     = $this->Producttransferwahousevd_model->FSnMTFWUpdateInlineDTTemp($aDataUpdateDT,$aDataWhere);
    ...
    public function FSnTFWUpdateHD(){
        ...
        //Get ค่า VATRate
        $cVatRate = $this->Producttransferwahousevd_model->FScMTFWGetVatRateFromDoc($tXthDocNo);

        //Get ค่า VAT InOrEx
        $tXthVATInOrEx = $this->Producttransferwahousevd_model->FCNxTFWGetvatInOrEx($tXthDocNo);

        //get จาก DT
        //ยอดรวมก่อนลด
        $cXthTotal          = $this->Producttransferwahousevd_model->FSaMTFWGetHDFCXthTotal($tXthDocNo); 
        //ยอดรวมมีภาษีห้ามลด
        $cXthVatNoDisChg    = $this->Producttransferwahousevd_model->FSaMTFWGetHDFCXthVatNoDisChg($tXthDocNo); 
        // echo "ยอดรวมมีภาษีห้ามลด :".$cXthVatNoDisChg."<br>";
        //ยอดรวมไม่มีภาษีห้ามลด
        $cXthNoVatNoDisChg  = $this->Producttransferwahousevd_model->FSaMTFWGetHDFCXthNoVatNoDisChg($tXthDocNo); 
        // echo "ยอดรวมไม่มีภาษีห้ามลด :".$cXthNoVatNoDisChg."<br>";
        //ยอดมีภาษีลดได้ 
        $cXthVatDisChgAvi   = $this->Producttransferwahousevd_model->FSaMTFWGetHDFCXthVatDisChgAvi($tXthDocNo); 
        // echo "ยอดมีภาษีลดได้ :".$cXthVatDisChgAvi."<br>";
        //ยอดไม่มีภาษีลดได้ 
        $cXthNoVatDisChgAvi = $this->Producttransferwahousevd_model->FSaMTFWGetHDFCXthNoVatDisChgAvi($tXthDocNo); 
        // echo "ยอดไม่มีภาษีลดได้ :".$cXthNoVatDisChgAvi."<br>";
    
        //ข้อมูลการ ลด ชาร์จ
        $aXthDisChgTxt = $this->Producttransferwahousevd_model->FSaMTFWGetHDFTXthDisChgTxt($tXthDocNo); 
        $tDisChgTxt = '';
        if($aXthDisChgTxt != 0){
        ...
        //get จาก HDDis
        //มูลค่ารวมส่วนลด
        $cXthDis            = $this->Producttransferwahousevd_model->FSaMTFWGetHDFCXthDis($tXthDocNo); 
        //มูลค่ารวมส่วนชาร์จ
        $cXthChg            = $this->Producttransferwahousevd_model->FSaMTFWGetHDFCXthChg($tXthDocNo); 

        //ยอดรวมมีภาษีหลังลด FCXthVatDisChgAvi-SUM(HDis.FCXddDisVat-HDis.FCXddChgVat)
        //Get SUM(HDis.FCXddDisVat-HDis.FCXddChgVat)
        $cXthDisRes    = $this->Producttransferwahousevd_model->FSaMTFWGetSUMFCXddDisVatMinusFCXddChgVat($tXthDocNo);
        $cXthVatAfDisChg    = $cXthVatDisChgAvi-$cXthDisRes;
        // echo "ยอดรวมมีภาษีหลังลด :".$cXthVatAfDisChg."<br>";

        //ยอดรวมไม่มีภาษีหลังลด
        $cXthNoVatAfDisChg  = $this->Producttransferwahousevd_model->FSaMTFWGetHDFCXthNoVatAfDisChg($tXthDocNo);
        // echo $cXthNoVatAfDisChg."<br>";

        //ยอดมัดจำ 
        $cFCXthRefAEAmt  = $this->Producttransferwahousevd_model->FSaMTFWGetFCXthRefAEAmt($tXthDocNo);
        ...
        if($oetXthWpTax != ''){
            ...
            $cXthWpTax = $this->Producttransferwahousevd_model->FSaMTFWGetHDFCXthWpTax($tXthDocNo);
        }
        ...
        $aStaUpdOrdHD = $this->Producttransferwahousevd_model->FSaMTFWUpdateOrdHD($Data,$DataWhere); /*ลงตาราง TAPTOrdHD */
    ...
    public function FSvCTFWApprove(){
        ...
        $aStaApv = $this->Producttransferwahousevd_model->FSvMTFWApprove($aDataUpdate); 
        ...
        //Get Data
        $aResult        = $this->Producttransferwahousevd_model->FSaMTFWGetHD($aDataWhere);       // Data TCNTPdtAdjStkHD
        $aInfoWhere = array(
            'FTXthDocNo'    => $tXthDocNo,
        ...
        $aDataInfor = $this->Producttransferwahousevd_model->FSaMTWXVDGetPdtLayoutToTem($aInfoWhere);
        $this->Producttransferwahousevd_model->FSxMUpdateBalToDT($aDataInfor,$aInfoWhere); 
        try{
            $aMQParams = [
    ...
    public function FSvCTFWCancel(){
        ...
        $aStaApv = $this->Producttransferwahousevd_model->FSvMTFWCancel($aDataUpdate); 
    ...
    public function FSaMTFWAddDT(){
        ...
        $aStaEventDelDT =  $this->Producttransferwahousevd_model->FSnMPMTDelPcoDT($this->input->post('oetSearchAll')); //*ลบ Data เก่าออก*/
        ...
        if($nNum != 0){
            foreach ($aDataFile['DTData'] as $key => $value) {
                ...
                $aStaEventOrdHDSpl  = $this->Producttransferwahousevd_model->FSaMTFWAddUpdateOrdDT($value); /*ลงตาราง TAPTOrdDT */
    ...
    public function FSaMTFWAddDTDis(){
        ...
        $aStaEventDelDTDis =  $this->Producttransferwahousevd_model->FSnMPMTDelPcoDTDis($tXthDocNo); //*ลบ Data เก่าออก*/
        ...
        if($nNum != 0){
            ...
            foreach ($aDataFile['DTData'] as $key => $valueDT) {
                ...
                foreach($valueDT['DTDiscount'] as $keyDis => $valueDTDis) {
                    ...
                    $aStaEventOrdDTDis  = $this->Producttransferwahousevd_model->FSaMTFWAddUpdateOrdDTDis($valueDTDis); /*ลงตาราง TAPTOrdDTDis */
                ...
                $aStaUpdDT  = $this->Producttransferwahousevd_model->FSaMTFWUpdateOrdDT($aDTData,$aDTDataWhere); /*Update TAPTOrdDT ใหม่ */
    ...
    public function FSaMTFWAddHDDis(){
        ...
        $aStaEventDelHDDis =  $this->Producttransferwahousevd_model->FSnMPMTDelPcoHDDis($tXthDocNo); //* ลบ Data เก่าออก */
        ...
        if($nNum > 0){
            ...
            foreach ($aDataFile['HDData'] as $key => $value) {
                ...
                $aStaEventOrdHDDis  = $this->Producttransferwahousevd_model->FSaMTFWAddUpdateHDDis($value); /*ลงตาราง TAPTOrdDT*/
    ...
    public function FSvCTFWAddPdtIntoTableDT(){
        ...
        $nCounts    = $this->Producttransferwahousevd_model->FSaMTFWGetCountDTTemp($aDataWhere);
        ...
        for($nI=0;$nI<count($aPdtData);$nI++){
            ...
            $aDataPdtMaster     =   $this->Producttransferwahousevd_model->FSaMTFWGetDataPdt($aDataPdtWhere); // Data Master Pdt
            
            


            
            $nStaInsPdtToTmp    =   $this->Producttransferwahousevd_model->FSaMTFWInsertPDTToTemp($aDataPdtMaster,$aDataPdtWhere);
    ...
    */
    public function FSnCTFWCalulateDTTemp($ptXthDocNo,$ptXthVATInOrEx){
            ...
            //Get DT Tmp
            $aDataDTTmp = $this->Producttransferwahousevd_model->FSaMTFWGetDTTemp($aDataWhere);
            ...
            if($aDataDTTmp['rtCode'] == 1){
                ...
                $aResUpd = $this->Producttransferwahousevd_model->FSnMWTOUpdateDTTemp($aDataDTTmp,$aDataWhere);
    ...
    public function FSaCTFWDeleteEvent(){
        ...
        $aResDel    = $this->Producttransferwahousevd_model->FSnMTFWDel($aDataMaster);
        $aReturn    = array(
    ...
    public function FSvCTFWRemovePdtInDTTmp(){
        ...
        $aResDel = $this->Producttransferwahousevd_model->FSnMTFWDelDTTmp($aDataWhere);
    ...
    public function FSxCTFWAddPage(){
        ...
        $this->Producttransferwahousevd_model->FSxMDeleteDoctemForNewEvent($aInfoWhere);

        $this->Producttransferwahousevd_model->FSxMClearPdtInTmp();
        //Get Option Show Decimal  
        $nOptDecimalShow = FCNxHGetOptionDecimalShow(); 
        ...
        $aDataUserGroup = $this->Producttransferwahousevd_model->FStTFWGetShpCodeForUsrLogin($aDataShp); // Get ข้อมูลสาขา และร้านค้าของ User ที่ login
        if($aDataUserGroup==''){
            $tBchCode   = '';
            $tBchName   = '';
            $tMchCode   = '';
    ...
    public function FSbCheckHaveProductForTransfer(){
        ...
        $nNumPdt = $this->Producttransferwahousevd_model->FSnMTFWCheckPdtTempForTransfer($tDocNo);
        if($nNumPdt>0){
    ...
    public function FSbCheckHaveProductInDT(){
        $tDocNo = $this->input->post("tDocNo");
        $tBchCode = $this->input->post("tBchCode");
        $nNumPdt = $this->Producttransferwahousevd_model->FSnMTFWCheckHaveProductInDT($tDocNo,$tBchCode);
        if($nNumPdt>0){
            echo json_encode(true);
        }else{
            echo json_encode(false);
    ...
    public function FSvCTFWEditPage(){
       ...
       //Lang ภาษา
        ...
        $aDataInfor = $this->Producttransferwahousevd_model->FSaMTWXVDGetPdtLayoutToTem($aInfoWhere);
        $aDataDT        = $this->Producttransferwahousevd_model->FSaMTFWGetDT($aDataWhere,$aDataInfor);       // Data TVDTPdtTwxDT
        $aStaIns        = $this->Producttransferwahousevd_model->FSaMTFWInsertDTToTemp($aDataDT["raItems"]);    // Insert Data DocTemp
    ...
    public function FSxCTFWDataTable(){
        ...
        $aResList   = $this->Producttransferwahousevd_model->FSaMTFWList($aData);
        $aGenTable  = array(
            'aAlwEvent'     => $aAlwEvent,
            'aDataList'     => $aResList,
            'nPage'         => $nPage,
        ...
        $this->Producttransferwahousevd_model->FSxMDeleteDoctemForNewEvent($aInfoWhere);
            ...
            if($aData){
                for($nI=0;$nI<count($aData);$nI++){
                    ...
                    $this->Producttransferwahousevd_model->FSxMUpdateDocTmpPdtFromDT($aInforInsert);
                }
            }
    ...
    public function FSvCTFWPdtAdvTblLoadData(){
        ...
        $aDataInfor       = $this->Producttransferwahousevd_model->FSaMTWXVDGetPdtLayoutFRomTem($aInfoWhere);
    ...
    */
    public function FSvCTFWVatLoadData(){
        ...
        $aDataVatDT     = $this->Producttransferwahousevd_model->FSaMTFWGetVatDTTemp($aDataWhere);
    ...
    */
    public function FSxCTWXVDPdtUpdateTem(){
        ...
        $this->Producttransferwahousevd_model->FSxMUpdateTmpMaxTransfer($aDataWhere);
    ...
    */
    ...
    public function FSvCTFWPdtMultiDeleteEvent(){
        ...
        if($nCount > 1){
            ...
            for($i=0;$i<$nCount;$i++){
                ...
                $aResDel = $this->Producttransferwahousevd_model->FSaMTFWPdtTmpMultiDel($aDataMaster);
            }
    ...
    public function FSxCTFXClearDocTemForChngCdt(){
        ...
        $this->Producttransferwahousevd_model->FSxMTFXClearDocTemForChngCdt(array(
    ...
    public function FSxCTWXCheckViaCodeForApv(){
        $tDocNo = $this->input->post('tXthDocNo');
        $aResult = $this->Producttransferwahousevd_model->FSxMTWXCheckViaCodeForApv($tDocNo);
        if($aResult){
