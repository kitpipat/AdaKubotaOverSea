...
class Saleperson_controller extends MX_Controller {
    
    public function __construct(){
        parent::__construct ();
        $this->load->model('pos/saleperson/Saleperson_model');
    ...
    public function FSvSPNDataList(){
        ...
        $tAPIReq = "";
        $tMethodReq = "GET";
        $aResList = $this->Saleperson_model->FSaMSPNList($tAPIReq, $tMethodReq, $aData);
        $aGenTable = array(
            'aDataList' => $aResList,
            'nPage' => $nPage,
            'tSearchAll' => $tSearchAll
    ...
    */
    public function FSvSPNEditPage(){
        ...
        $tAPIReq        = "";
        $tMethodReq     = "GET";
        $aSpnData       = $this->Saleperson_model->FSaMSPNSearchByID($tAPIReq, $tMethodReq, $aData);
    ...
    public function FSaSPNAddEvent(){
        ...
        if($tSpnLevel == 1){ // Branch level : 1
            ...
            $tBchCode = $this->Shop_model->FSaMSHPSearchByID($aShop)['roItem']['rtBchCode'];
        ...
        // print_r($aDataMaster);
        // exit;
        $oCountDup  = $this->Saleperson_model->FSoMSPNCheckDuplicate($aDataMaster['FTSpnCode']);
        $nStaDup    = $oCountDup[0]->counts;
        if($nStaDup == 0){
            $this->db->trans_begin();
            $this->Saleperson_model->FSaMSPNAddUpdateMaster($aDataMaster);
            $this->Saleperson_model->FSaMSPNAddUpdateLang($aDataMaster);
            $this->Saleperson_model->FSaMSPNAddUpdateGroup($aDataMaster);
    ...
    //     $aResDel = $this->Saleperson_model->FSnMSPNDel($aDataMaster);
    //     $aReturn = array(
    ...
    //         $this->Saleperson_model->FSnMSPNDel($aSpn);
    //     }
    ...
    public function FSoSPNDelete(){
        ...
        $aResDel        =  $this->Saleperson_model->FSnMSPNDel($aDataMaster);
        $nNumRowSpnLoc  =  $this->Saleperson_model->FSnMLOCGetAllNumRow();
