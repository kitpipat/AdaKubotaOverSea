...
class Compsettingconnection_controller extends MX_Controller {
    public function __construct() {
        parent::__construct ();
        $this->load->model('company/compsettingconnection/Compsettingconnection_model');
    ...
    public function FSvCCompConnectDataList(){
        ...
        $aResList    = $this->Compsettingconnection_model->FSaMCompSetConnectDataList($aData);

        // Check URL Type
        $aCheckUrlType = $this->Compsettingconnection_model->FSaMCompSetConCheckUrlType($aData);
    ...
    public function FSvCCompConnectPageEdit(){
        ...
        // TCNTUrlObject
        $aResult    = $this->Compsettingconnection_model->FSaMCompGetConCheckID($aData);
    ...
    public function FSaCCompConnectAddEvent(){
        try{
            ...
            $aChkAddress  = $this->Compsettingconnection_model->FSaMCompSetConCheckUrlAddress($aDataUrlObj); 
            ...
            if($aChkAddress['rtCode'] == 1){
                ...
                switch($nUrlType){
                    ...
                    case '3' :  // Type 3 url + MQ
                        $aStaMaster  = $this->Compsettingconnection_model->FSaMCompSetConAddUpdateMasterUrlMQ($aDataUrlObj,$aDataMQMain,$aDataMQDoc,$aDataMQSale,$aDataMQReport);
                    break;
                    ...
                    case '13' : // Type 8 tCompURLAPI2MQMember
                        $aStaMaster  = $this->Compsettingconnection_model->FSaMCompSetConAddMasterUrlMQMember($aDataUrlObj,$aDataMQMain); 
                    break;
                ...
                $this->Compsettingconnection_model->FSxMCompSetConSetLastUpdateOnBranch($aLastUpdate);
                ...
                if($this->db->trans_status() === false){
                    ...
                    //update Seq
                    $this->Compsettingconnection_model->FSaMCompSetConUpdateSeqNumber();

                    // Update Img Parth โดยดึงจาก ImageObj
                    $this->Compsettingconnection_model->FSaMCompSetConAddUpdatePathUrl($aDataUrlObj);
    ...
    public function FSaCCompConnectEditEvent(){
        ...
        if($toldUrltype !=  $nUrlType){
            ...
            if($bChkAddress == true){
                $aChkAddress  = $this->Compsettingconnection_model->FSaMCompSetConCheckUrlAddressUpdate($aDataUrlObj); 
            ...
            if($tPass  ==  true){
                switch($nUrlType){
                    case '1':  // Type 1 URL
                        $aStaMaster  = $this->Compsettingconnection_model->FSaMCompSetConAddUpdateMasterUrlUpdate($aDataUrlObj,$tOldKeyUrl); 
                    break;
                    ...
                    break;
                    case '3' :  // Type 3 url + MQ
                        $aStaMaster  = $this->Compsettingconnection_model->FSaMCompSetConAddUpdateMasterUrlMQUpdate($aDataUrlObj,$aDataMQMain,$aDataMQDoc,$aDataMQSale,$aDataMQReport,$tOldKeyUrl);
                    break;
                    case '4':  // Type 4 API2PSMaster
                        $aStaMaster  = $this->Compsettingconnection_model->FSaMCompSetConAddUpdateMasterUrlUpdate($aDataUrlObj,$tOldKeyUrl); 
                    break;
    ...
    public function FSaCCompConnectDeleteEvent(){
        ...
        $aResDel       = $this->Compsettingconnection_model->FSnMCompSettingConDel($aDataMaster);
        
        //Update Seqent number
        $this->Compsettingconnection_model->FSaMCompSetConUpdateSeqNumber();
        $nNumRowRsnLoc  = $this->Compsettingconnection_model->FSnMCompSettingConGetAllNumRow();
    ...
    public function  FSoCCompConnectDelMultipleEvent(){
        try{
            ...
            $aDataDeleteMuti = array(
             ...
             $tResult    = $this->Compsettingconnection_model->FSaMCompSetingConnDeleteMultiple($aDataDeleteMuti);
