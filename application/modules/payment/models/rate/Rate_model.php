...
class Rate_model extends CI_Model
{
    ...
    public function FSaMRTESearchByID($paData)
    {
        ...
        $tSQL   = " SELECT
                    ...
                    LEFT JOIN [TCNMImgObj] IMGO WITH(NOLOCK) ON RTE.FTAgnCode+RTE.FTRteCode = IMGO.FTImgRefID AND IMGO.FTImgTable = 'TFNMRate' AND IMGO.FTCreateBy = RTE.FTCreateBy AND IMGO.FNImgSeq = 1
    ...
    public function FSaMRTEList($paData)
    {
        ...
        $tSQL   = " SELECT c.* FROM(
                        ...
                        FROM
                            ...
                            LEFT JOIN [TCNMImgObj] IMGO ON RTE.FTAgnCode+RTE.FTRteCode = IMGO.FTImgRefID  AND IMGO.FTImgTable = 'TFNMRate' AND IMGO.FTCreateBy = RTE.FTCreateBy AND IMGO.FNImgSeq  = 1
                            LEFT JOIN [TCNMAgency_L] AGNL WITH(NOLOCK) ON AGNL.FTAgnCode = RTE.FTAgnCode
                            WHERE 1=1
                    ";
