...
class Recive_controller extends MX_Controller
{
    ...
    public function FSvRCVDataList()
    {
        ...
        $tAPIReq        = "";
        $tMethodReq     = "GET";
        $aResList       = $this->Recive_model->FSaMRCVList($tAPIReq, $tMethodReq, $aData);
    ...
    public function FSvRCVAddPage()
    {
        ...
        $tAPIReq        = "";
        $tMethodReq     = "GET";
        $aRcvFmtData    = $this->Recive_model->FSaMRCVFormat($tAPIReq, $tMethodReq, $aData);
    ...
    public function FSvRCVEditPage()
    {
        ...
        $tAPIReq        = "";
        $tMethodReq     = "GET";
        $aRcvData       = $this->Recive_model->FSaMRCVSearchByID($tAPIReq, $tMethodReq, $aData);
    ...
    public function FSaRCVDeleteEvent()
    {
        ...
        $tMethodReq     = 'POST';
        $aResDel        = $this->Recive_model->FSnMRCVDel($tAPIReq, $tMethodReq, $aDataMaster);
        $nNumRowRcvLoc  = $this->Recive_model->FSnMLOCGetAllNumRow();
        if ($aResDel['rtCode'] == 1) {
            $aDeleteImage = array(
                'tModuleName'  => 'payment',
                'tImgFolder'   => 'recive',
