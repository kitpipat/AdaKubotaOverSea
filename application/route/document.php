...
$route['docPODocPreOrdBExport']                     = 'document/purchaseorder/cPurchaseOrder/FSoCPOExport';
...
// หน้าจอ ใบเรียกเก็บประจำเดือน - แฟรนไชส์
$route['docInvoiceRytAndMktFee/(:any)/(:any)']          = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/index/$1/$2';
$route['docInvoiceRytAndMktFeePageList']                = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSvCTRMCPageList';
$route['docInvoiceRytAndMktFeeDataTable']               = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSvCTRMDatatable';
$route['docInvoiceRytAndMktFeePageAdd']                 = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSvCTRMPageAdd';
$route['docInvoiceRytAndMktFeePageEdit']                = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSvCTRMPageEdit';
$route['docInvoiceRytAndMktFeeEventAdd']                = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSvCTRMEventAdd';
$route['docInvoiceRytAndMktFeeEventEdit']               = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSvCTRMEventEdit';
$route['docInvoiceRytAndMktFeeFindingAgnBch']           = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSoCTRMFindingAgnBch';
$route['docInvoiceRytAndMktFeeFindingAgnBchAddress']    = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSoCTRMFindingAgnBchAddress';
$route['docInvoiceRytAndMktFeeFindingSale']             = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSoCTRMFindingSale';
$route['docInvoiceRytAndMktFeeClearTemp']               = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSoCTRMClearTmp';
$route['docInvoiceRytAndMktFeeLoadSalePage']            = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSoCTRMLoadSalePage';
$route['docInvoiceRytAndMktFeeChkDataInDTTmp']          = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSoCTRMChkDataInDTTmp';
$route['docInvoiceRytAndMktFeeEventDelete']             = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSoCTRMEventDelete';
$route['docInvoiceRytAndMktFeeEventCancel']             = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSoCTRMEventCancel';
$route['docInvoiceRytAndMktFeeEventAppove']             = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSoCTRMEventAppove';
$route['docInvoiceRytAndMktFeeChkDocHaveInDB']          = 'document/invoicerytandmktfee/Invoicerytandmktfee_controller/FSoCTRMChkDocHaveInDB';
